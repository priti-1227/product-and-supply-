...
>
  ...
  /></Box></Card>
    ...
    <Box sx={{display:"flex",width:{ xs: "100%", md:"50%"}, gap:3}}>
      <Card sx={{width:{ xs: "100%", md:"50%"} , p:3}} ><Typography variant="h4" fontWeight={500} >Lowest Price Items</Typography>
      <Typography variant="h5" fontWeight={400} mt={1} >steel</Typography>
